"""
BetaScope Design System — High-Density Institutional Theme Engine.
...
def apply_custom_css(theme: str = None) -> None:
    """Inject the dynamic BetaScope design system CSS into the Streamlit app."""
    ...
    if active_theme == "light":
        ...
        /* Light mode segmented control overrides */
